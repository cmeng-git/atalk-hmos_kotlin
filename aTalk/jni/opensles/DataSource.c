...
Java_org_atalk_impl_neomedia_jmfext_media_protocol_opensles_DataSource_00024Companion_connect
    (JNIEnv *jniEnv, jclass clazz,
     jstring encoding, jdouble sampleRate, jint sampleSizeInBits, jint channels,
     jint endian, jint zigned, jclass dataType)
{
    ...
    if (thiz)
    {
        ...
        if (SL_RESULT_SUCCESS != SLresult_)
        {
            Java_org_atalk_impl_neomedia_jmfext_media_protocol_opensles_DataSource_00024Companion_disconnect(
                jniEnv, clazz,
                (jlong) (intptr_t) thiz);
            thiz = NULL;
        }
...
Java_org_atalk_impl_neomedia_jmfext_media_protocol_opensles_DataSource_00024Companion_read
...
JNIEXPORT void JNICALL
Java_org_atalk_impl_neomedia_jmfext_media_protocol_opensles_DataSource_00024Companion_start
    (JNIEnv *jniEnv, jclass clazz, jlong ptr)
{
...
JNIEXPORT void JNICALL
Java_org_atalk_impl_neomedia_jmfext_media_protocol_opensles_DataSource_00024Companion_stop
    (JNIEnv *jniEnv, jclass clazz, jlong ptr)
{
    DataSource_setRecordState(
        (DataSource *) (intptr_t) ptr,
