 ...
 */
class ChatMessageDeleteFragment : OSGiFragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        val viewHistoryDelete = inflater.inflate(R.layout.chat_history_delete, container, false)
        setTextViewValue(viewHistoryDelete, R.id.textView, arguments?.getString(ARG_MESSAGE))
