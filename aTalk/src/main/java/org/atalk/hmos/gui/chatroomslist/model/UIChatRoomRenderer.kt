 ...
 */
interface UIChatRoomRenderer {
    /**
     * Return `true` if given contact is considered to be currently selected.
     *
     * @param chatRoomWrapper chatRoomWrapper instance.
     * @return `true` if given chatRoomWrapper is considered to be currently selected.
     */
    fun isSelected(chatRoomWrapper: Any): Boolean
     ...
     */
    fun getDisplayName(chatRoomWrapper: Any): String?
     ...
     */
    fun getStatusMessage(chatRoomWrapper: Any): String

    /**
     * Returns `true` if given chatRoomWrapper name should be displayed in bold.
     *
     * @param chatRoomWrapper chatRoomWrapper instance.
     * @return `true` if given chatRoomWrapper name should be displayed in bold.
     */
    fun isDisplayBold(chatRoomWrapper: Any): Boolean
     ...
     */
    fun getChatRoomIcon(chatRoomWrapper: Any?): Drawable?
     ...
     */
    fun getChatRoomID(chatRoomWrapper: Any): String
    fun isAutoJoin(chatRoomWrapper: Any): Boolean
    fun isBookmark(chatRoomWrapper: Any): Boolean
}