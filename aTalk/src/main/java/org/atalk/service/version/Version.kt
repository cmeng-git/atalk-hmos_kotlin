...
interface Version : Comparable<Version?> {
     ...
     * `null<tt></tt> otherwise. Note that pre-release versions are not used by Jitsi's current
    ...
    companion object {
        /**
         * The name of the `System` property the value of which is equal to the value of
         * [.getApplicationName]. Expected to be set by implementers of the
         * `VersionService` and `Version` interfaces.
         */
        const val PNAME_APPLICATION_NAME = "sip-communicator.application.name"

        /**
         * The name of the `System` property the value of which is equal to the value of
         * [.toString]. Expected to be set by implementers of the `VersionService` and
         * `Version`  interfaces.
         */
        const val PNAME_APPLICATION_VERSION = "sip-communicator.version"
    }
}