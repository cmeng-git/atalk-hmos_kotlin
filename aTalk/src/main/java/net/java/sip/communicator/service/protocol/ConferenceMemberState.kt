...
/**
 * Represents the state of the device and signaling session of `ConferenceMember` in the
 * conference it is participating in.
 *
 * @author Lubomir Marinov
 * @author Yana Stamcheva
 */
enum class ConferenceMemberState
/**
 * Creates an instance of `ConferenceMemberState` by specifying the name of the state.
 *
...
(
    ...
    /**
     * The state of the device and signaling session of the associated `ConferenceMember`
     * in the conference is unknown.
     */
    UNKNOWN("Unknown");

    /**
     * Returns the name of this `ConferenceMemberState` (e.g. "connected" or "dialing out").
     ...
     *
     * @return the name of this `ConferenceMemberState` (e.g. "connected" or "dialing out")
     */
