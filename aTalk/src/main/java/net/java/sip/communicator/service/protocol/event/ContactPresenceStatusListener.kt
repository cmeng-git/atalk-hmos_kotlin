...
/**
 * `ContactPresenceStatusListener`s listener for events caused by changes in the status of
 ...
 */
interface ContactPresenceStatusListener : EventListener {
    /**
     ...
     */
    fun contactPresenceStatusChanged(evt: ContactPresenceStatusChangeEvent)
}