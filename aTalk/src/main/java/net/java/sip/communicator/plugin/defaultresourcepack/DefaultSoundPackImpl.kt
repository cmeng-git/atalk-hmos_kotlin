 ...
 */
class DefaultSoundPackImpl : SoundPack {
    /**
    ...
    private fun initPluginResources(resources: MutableMap<String?, String?>) {
        val pluginProperties = DefaultResourcePackActivator.findResourcePaths("resources/sounds", "sounds-*.properties")
    ...
    companion object {
        private const val DEFAULT_RESOURCE_PATH = "resources.sounds.sounds"
    }
}