 ...
 */
class OperationSetThumbnailedFileFactoryImpl : OperationSetThumbnailedFileFactory {
    /**
     ...
     */
    override fun createFileWithThumbnail(file: File, thumbnailWidth: Int, thumbnailHeight: Int,
            thumbnailMimeType: String, thumbnail: ByteArray): File {
        return ThumbnailedFile(file, thumbnailWidth, thumbnailHeight, thumbnailMimeType, thumbnail)
    }
}