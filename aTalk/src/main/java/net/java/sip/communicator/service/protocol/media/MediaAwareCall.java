...
public abstract class MediaAwareCall<
    ...
    public void addCallPeer(T callPeer) {
        ...
        fireCallPeerEvent(callPeer, CallPeerEvent.CALL_PEER_ADDED, false);
    }
...
//     */
//    public void peerImageChanged() {
//        peerImageChanged(null);
//    }
     ...
     * @param evt unused.
     */
    public void peerAddressChanged(@NonNull CallPeerChangeEvent evt) {
        // does not concern us
    }
     ...
     * @param evt unused.
     */
    public void peerTransportAddressChanged(@NonNull CallPeerChangeEvent evt) {
        // does not concern us
    }
     ...
     * @param evt unused.
     */
    public void peerDisplayNameChanged(@NonNull CallPeerChangeEvent evt) {
        // does not concern us
    }
    ...
    public Recorder createRecorder()
        ...
        final Recorder recorder
                = Objects.requireNonNull(ProtocolMediaActivator.getMediaService()).createRecorder(getDefaultDevice(MediaType.AUDIO));
     ...
     */
    @Override
    protected void setCallState(@NonNull CallState newState, CallPeerChangeEvent cause) {
        try {
            super.setCallState(newState, cause);
        } finally {
            if (CallState.CALL_ENDED.equals(getCallState()))
                Objects.requireNonNull(ProtocolMediaActivator.getMediaService()).removePropertyChangeListener(this);
        }
    }
     ...
     */
    @Override
    public void setConference(@NonNull CallConference conference) {
