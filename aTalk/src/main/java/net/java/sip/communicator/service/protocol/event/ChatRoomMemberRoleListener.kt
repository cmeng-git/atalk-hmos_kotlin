 ...
 */
interface ChatRoomMemberRoleListener : EventListener {
    /**
     * Called to notify interested parties that a change in the role of a chat room member has
     * occurred.
     *
     * @param evt the `ChatRoomMemberRoleChangeEvent` instance containing the source chat room
     * and role old and new state.
     */
    fun memberRoleChanged(evt: ChatRoomMemberRoleChangeEvent)
}