...
interface MessageListener : EventListener {
     ...
     *
     * @param evt the `MessageReceivedEvent` containing the newly received message, its sender
     * and other details.
     */
