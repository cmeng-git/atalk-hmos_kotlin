...
interface GlobalStatusService {
     ...
     */
    fun publishStatus(status: GlobalStatusEnum?)
     ...
     */
    fun publishStatus(protocolProvider: ProtocolProviderService, status: PresenceStatus, state: Boolean)
}