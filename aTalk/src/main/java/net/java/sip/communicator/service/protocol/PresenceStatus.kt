...
protected constructor(
         ...
         */
        open val statusIcon: ByteArray? = null) : Comparable<PresenceStatus> {
    /**
    ...
    </MESSAGE_STATUS></STATUS_STRING> */
    override fun toString(): String {
        return "PresenceStatus:$statusName"
    }
    ...
    val isAvailable: Boolean
        get() = status >= AVAILABLE_THRESHOLD
     ...
     * and false otherwise
     */
    val isEagerToCommunicate: Boolean
        get() = status >= EAGER_TO_COMMUNICATE_THRESHOLD
     ...
     *
     * @param other the `PresenceStatus` to be compared.
    ...
    override fun compareTo(other: PresenceStatus): Int {
     ...
     * @return `true` if this presence status instance is equal to the `obj`
     * argument; `false` otherwise.
     */
    override fun equals(other: Any?): Boolean {
        if (other !is PresenceStatus) return false
        val status = other
        return status.status == this.status && status.statusName == statusName
    }
