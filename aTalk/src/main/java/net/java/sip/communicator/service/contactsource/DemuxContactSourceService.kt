 ...
 */
abstract class DemuxContactSourceService {
    /**
     * Creates a de-multiplexed copy of the given `ContactSourceService`,
     ...
     *
     * @param contactSourceService the original `ContactSourceService` to be de-multiplexed
     * @return a de-multiplexed copy of the given `ContactSourceService`
     */
    abstract fun createDemuxContactSource(
            contactSourceService: ContactSourceService?): ContactSourceService?
}