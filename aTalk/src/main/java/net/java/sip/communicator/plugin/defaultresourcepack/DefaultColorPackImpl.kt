 ...
 */
class DefaultColorPackImpl : ColorPack {
    /**
     ...
     */
    private fun initResources(resourceBundle: ResourceBundle,
    ...
    private fun initPluginResources(resources: MutableMap<String?, String?>) {
        val pluginProperties = DefaultResourcePackActivator.findResourcePaths("resources/colors",
                "colors-*.properties")
    ...
    companion object {
        private const val DEFAULT_RESOURCE_PATH = "resources.colors.colors"
    }
}