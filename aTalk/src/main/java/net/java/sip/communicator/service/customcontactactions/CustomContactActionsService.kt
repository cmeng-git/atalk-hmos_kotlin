...
/**
 * The `CustomContactActionsService` can be used to define a set of
 * custom actions for a contact list entry.
 *
 * @author Damian Minkov
 */
interface CustomContactActionsService<T> {
    /**
     * Returns the template class that this service has been initialized with
     *
     * @return the template class
     */
    fun getContactSourceClass(): Class<T>?

    /**
     * Returns all custom actions defined by this service.
     *
     * @return an iterator over a list of `ContactAction`s
     */
    fun getCustomContactActions(): Iterator<ContactAction<T>?>?

    /**
     * Returns all custom actions menu items defined by this service.
     *
     * @return an iterator over a list of `ContactActionMenuItem`s
     */
    fun getCustomContactActionsMenuItems(): Iterator<ContactActionMenuItem<T>?>?
}