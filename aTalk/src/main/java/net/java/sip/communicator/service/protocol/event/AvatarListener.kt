 ...
 * the avatar operation set, using its `addAvatarListener` method. When a avatar event
 * occurs, that object's `avatarChanged` method is invoked.
 *
 * @author Damien Roth
 * @author Eng Chong Meng
 * @see AvatarEvent
 */
interface AvatarListener : EventListener {
    /**
     ...
     */
    fun avatarChanged(event: AvatarEvent)
}