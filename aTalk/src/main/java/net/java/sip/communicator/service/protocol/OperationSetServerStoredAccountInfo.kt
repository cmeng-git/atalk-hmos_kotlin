 ...
 */
interface OperationSetServerStoredAccountInfo : OperationSet {
    /**
     ...
     */
    fun <T : ServerStoredDetails.GenericDetail?> getDetailsAndDescendants(detailClass: Class<T>?): Iterator<T?>?
     ...
     */
    fun getDetails(detailClass: Class<out ServerStoredDetails.GenericDetail?>?): Iterator<ServerStoredDetails.GenericDetail?>?
     ...
     */
    fun getAllAvailableDetails(): MutableIterator<ServerStoredDetails.GenericDetail?>?
     ...
     */
    fun getSupportedDetailTypes(): Iterator<Class<out ServerStoredDetails.GenericDetail?>?>?
     ...
     */
    fun isDetailClassSupported(detailClass: Class<out ServerStoredDetails.GenericDetail?>?): Boolean
     ...
     */
    fun isDetailClassEditable(detailClass: Class<out ServerStoredDetails.GenericDetail?>?): Boolean
     ...
     */
    fun getMaxDetailInstances(detailClass: Class<out ServerStoredDetails.GenericDetail?>?): Int
     ...
     */
    @Throws(IllegalArgumentException::class, OperationFailedException::class, ArrayIndexOutOfBoundsException::class)
    fun addDetail(detail: ServerStoredDetails.GenericDetail?)
    ...
    fun removeDetail(detail: ServerStoredDetails.GenericDetail?): Boolean
    ...
    fun replaceDetail(currentDetailValue: ServerStoredDetails.GenericDetail?,
                      newDetailValue: ServerStoredDetails.GenericDetail?): Boolean
     ...
     */
    fun addServerStoredDetailsChangeListener(listener: ServerStoredDetailsChangeListener)
     ...
     */
    fun removeServerStoredDetailsChangeListener(listener: ServerStoredDetailsChangeListener)
}