...
/**
 * The `ChatRoomConfigurationForm` contains the chat room configuration. It's meant to be
 ...
 * user with the user interface representation and the possibility to change it. <br></br>
 * The `ChatRoomConfigurationForm` contains a list of `ChatRoomConfigurationFormField`
...
interface ChatRoomConfigurationForm {
    /**
     * Returns an Iterator over a set of `ChatRoomConfigurationFormField`s, containing the
     ...
     *
     * @return a list of `ChatRoomConfigurationFormField`s, containing the current
     * configuration of the chat room
     */
    fun getConfigurationSet(): Iterator<ChatRoomConfigurationFormField?>?
