 ...
 */
(source: MetaContact?, oldAvatar: ByteArray?, newAvatar: ByteArray?) : MetaContactPropertyChangeEvent(source, MetaContactPropertyChangeEvent.Companion.META_CONTACT_AVATAR_UPDATE, oldAvatar, newAvatar) {
    /**
     ...
     */
    fun getOldAvatar(): ByteArray {
        return oldValue as ByteArray
    }
