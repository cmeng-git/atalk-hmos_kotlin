 ...
 */
class SysActivityActivator : BundleActivator {
    /**
    ...
    override fun start(bundleContext: BundleContext) {
        ...
        Timber.d("Started.")
        systemActivityService = SystemActivityNotificationsServiceImpl()
        systemActivityService!!.start()
        bundleContext.registerService(SystemActivityNotificationsService::class.java.name,
                systemActivityService, null)
    }
    ...
    override fun stop(bundleContext: BundleContext) {
        if (systemActivityService != null) systemActivityService!!.stop()
    }
    ...
    companion object {
         ...
         */
        var systemActivityService: SystemActivityNotificationsServiceImpl? = null
            private set
    }
}