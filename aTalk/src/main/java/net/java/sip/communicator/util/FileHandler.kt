...
class FileHandler : java.util.logging.FileHandler {
     ...
     * entirely from `LogManager` properties (or their default values). Will change
     *
     *
     *
     * @throws IOException if there are IO problems opening the files.
    ...
    companion object {// default value
        ...
        /**
         * Specifies a pattern for generating the output file name. A pattern consists of a string that
         * includes the special components that will be replaced at runtime such as : %t, %h, %g, %u.
         *
        ...
        var pattern: String? = null
            ...
            get() {
                if (field == null) {
                    ...
                    val homeLocation = System.getProperty("net.java.sip.communicator.SC_LOG_DIR_LOCATION")
                    val dirName = System.getProperty("net.java.sip.communicator.SC_HOME_DIR_NAME")
                    ...
                    checkDestinationDirectory(field)
                }
                return field
            }
         ...
         */
        private fun checkDestinationDirectory(pattern: String?) {
            try {
