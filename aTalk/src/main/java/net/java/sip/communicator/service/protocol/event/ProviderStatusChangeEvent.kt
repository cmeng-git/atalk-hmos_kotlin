...
/**
 * Creates an event instance indicating a change of the property specified by `eventType`
 ...
 */
(source: ProtocolProviderService?, eventType: String?,
 oldValue: PresenceStatus?, newValue: PresenceStatus?) : PropertyChangeEvent(source, eventType, oldValue, newValue) {
    /**
     ...
     */
    fun getOldStatusValue(): PresenceStatus {
     ...
     */
    fun getNewStatusValue(): PresenceStatus {
